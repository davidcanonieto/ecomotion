                        ...
                        <div class="login-form mt-3">
                            <form action="database/withdraw.php" method="post">
                                ...
                                <div class="form-group buttons-menu text-center">
                                    ...
                                    <input type="number" step="any" min="0" max="<?php echo $_SESSION['credit'] ?>" class="form-control text-center" name="withdraw"
                                ...
                                <button type="submit" class="btn btn-block btn-primary mx-auto d-block my-5">Retirar fondos</button>
                            </form>
                            <p class="text-center mt-5">(*)Se realizará un envío a la cuenta PayPal que tienes asociada a EcoMotion</p>
                        </div>
                    </div>
                </div>
            </div>

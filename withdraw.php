...
<body>
    ...
    <div id="main">
        ...
        <div class="login-form mt-3">
            <form action="database/withdraw.php" method="post">
                <div class="text-center mb-5">
                    <div class="btn-group" role="group">
                        <a class="btn btn-primary px-5" href="./topup.php">Recarga</a>
                        <a class="btn btn-primary px-5 active" href="#">Retirar</a>
                    </div>
                </div>
                ...
                ?>
                <div class="form-group buttons-menu text-center">
                    <label for="withdraw" class="text-center">Retirar fondos</label>
                    <input type="number" step="any" min="0" max="<?php echo $_SESSION['credit'] ?>" class="form-control text-center" name="withdraw" placeholder="10.00€" required>
                </div>
                <hr>
                ...
                <button type="submit" class="btn btn-block btn-primary">Retirar fondos</button>
            </form>
        </div>
        <p class="text-center">(*)Se realizará un envío a la cuenta PayPal que tienes asociada a EcoMotion</p>
    </div>
